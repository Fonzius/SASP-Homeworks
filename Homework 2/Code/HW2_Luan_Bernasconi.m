...
y1 = audioread("DAAP_HW2_reference_files/y1.wav");
y2 = audioread("DAAP_HW2_reference_files/y2.wav");
...
if ~exist('Outuput','dir')
    mkdir('Output');
end

audiowrite("Output/Luan_Bernasconi_f1.wav",real(f1_reconstructed), fs);
audiowrite("Output/Luan_Bernasconi_f2.wav",real(f2_reconstructed), fs);
audiowrite("Output/Luan_Bernasconi_f3.wav",real(f3_reconstructed), fs);
